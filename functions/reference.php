 ...
 * 
 * @link	Codex Reference: add_theme_page()
 * 
 * @uses	oenology_get_settings_page_cap()	Defined in \functions\options.php
 */
...
function oenology_admin_reference_page() { ?>
	...
	<div class="wrap">
		...
		/**
		 * Output Reference Page Tab Content
		 */
		global $pagenow;
...
function oenology_reference_page_general() { 
	...
	or "fluid". The "fixed" option behaves as before. The "fluid" option allows for long Page Titles not to 
...
function oenology_reference_page_faq() { 
	...
	<h3>What is the Code Reference?</h3>

	<p>The Code Reference is the master cross-reference file, that contains all of the functions, template tags, 
	...
	<p>Other features that may be added in the future, as determined by user feedback/demand, and changes to WordPress.</p>
			...
			<div id="normal-sortables" class="meta-box-sortable ui-sortable">
				...
				<div class="postbox">
					...
					<div class="inside">
						...
						<?php echo oenology_get_github_api_data( 'issues', 'open', '*', true ); ?>
