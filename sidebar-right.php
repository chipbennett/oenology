...
/**
 * Output core "Calendar" widget
 * 
 * Outputs the core "Calendar" Widget, with the "Posts Calendar" name as Title.
 *  
 * @uses	the_widget()
 * 
...
/**
 * Output core "Archives" widget
 * 
 * Outputs the core "Archives" Widget.
 *  
 * @uses	the_widget()
 * 
 * @param	string	$widget		name of the Widget to output; default: none
...
/**
 * Output core "Recent Posts" widget
 * 
 * Outputs the core "Recent Posts" Widget.
 *  
 * @uses	the_widget()
 * 
 * @param	string	$widget		name of the Widget to output; default: none
